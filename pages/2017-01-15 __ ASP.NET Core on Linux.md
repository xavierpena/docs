...
**Note:** in the last version of ASP.NET Core [it uses launchSettings.json](https://docs.microsoft.com/en-us/aspnet/core/fundamentals/environments), instead of this sepparate file `hosting.json`.
